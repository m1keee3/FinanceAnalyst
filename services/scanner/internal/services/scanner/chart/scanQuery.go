...
func NewScanQuery(req *scannerv1.ChartScanRequest) *ScanQuery {
	...
	options := protoToChartScanOptions(req.GetOptions())
...
// protoToChartScanOptions конвертирует proto ChartScanOptions в ScanOptions
func protoToChartScanOptions(proto *scannerv1.ChartScanOptions) ScanOptions {
	if proto == nil {
		return ScanOptions{}
	}
